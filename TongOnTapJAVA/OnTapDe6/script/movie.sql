...
VALUES ('PUB1', 'O\'Reilly Media', '1005 Gravenstein Hwy N, Sebastopol, CA', 'contact@oreilly.com', '+1-800-998-9938'),
       ('PUB2', 'Penguin Random House', '1745 Broadway, New York, NY', 'info@penguinrandomhouse.com',
        '+1-212-782-9000'),
...
-- 2. People
INSERT INTO people (person_id, last_name, first_name, email, professional_title)
VALUES (1, 'Nguyễn', 'An', 'an.nguyen@example.com', 'Software Engineer'),
...
-- 3. Books
INSERT INTO books (ISBN, name, publish_year, num_of_pages, price, publisher_id)
VALUES ('9780134685991', 'Effective Java', 2018, 416, 45.50, 'PUB1'),
...
-- 4. Authors
INSERT INTO books_authors (ISBN, author)
...
-- 5. Book Translations
INSERT INTO book_translations (ISBN, language, translate_name)
VALUES ('9780134685991', 'vi', 'Java Hiệu Quả'),
...
-- 6. Reviews
INSERT INTO reviews (person_id, ISBN, rating, comment)
VALUES (1, '9780134685991', 5, 'Rất hữu ích cho Java高手'),
